...
foreach varstub in track advancepaymentmodel totalassignedbeneficiaries totalbenchmarkexpenditures totalexpenditures expendituredollar expenditurepercent generatedsavingslosses /*earnedsavingsowelosses*/ reportedquality qualityscore aco1 aco2 aco3 aco4 aco5 aco6 aco7 aco8 aco9 aco10 aco11 aco13 aco14 aco15 aco16 aco17 aco18 aco19 aco20 dmcomposite aco21 aco27 aco28 aco30 aco31 aco33 aco34 aco35 aco36 aco37 aco38 aco39 aco40 aco41{
	*Don't do the replacement for Pioneer switchers (want their data to still be _PY2)
	replace `varstub'_PY1=`varstub'_PY3 if (start_date=="01/01/2015" & !inlist(aconame_cms,"HCP ACO California, LLC","Seton Accountable Care Organization, Inc.","Premier Choice ACO, Inc.","Physician Health Partners, LLC", "Franciscan Alliance ACO"))
	*Some ACO quality measures dropped in PY3 data - replace PY2 as blank*
	replace `varstub'_PY3=. if (start_date=="01/01/2015" & !inlist(aconame_cms,"HCP ACO California, LLC","Seton Accountable Care Organization, Inc.","Premier Choice ACO, Inc.","Physician Health Partners, LLC", "Franciscan Alliance ACO"))
}
...
foreach varstub in track advancepaymentmodel totalassignedbeneficiaries totalbenchmarkexpenditures totalexpenditures /*expendituredollar expenditurepercent*/ generatedsavingslosses /* earnedsavingsowelosses */ reportedquality qualityscore aco1 aco2 aco3 aco4 aco5 aco6 aco7 aco8 aco9 aco10 aco11 aco12 aco13 aco14 aco15 aco16 aco17 aco18 aco19 aco20 aco21 dmcomposite /*aco22 aco23 aco24 aco25 aco26 */ aco27 aco28 /* aco29 */aco30 aco31/*cadcomposite  aco32 */ aco33 aco34 aco35 aco36 aco37 aco38 aco39 aco40 aco41 aco42{
	*Don't do the replacement for Pioneer switchers (want their data to still be _PY2)  //BU: or PY4 for Franciscan alliance
...
foreach varstub in track advancepaymentmodel totalassignedbeneficiaries totalbenchmarkexpenditures totalexpenditures /* expendituredollar expenditurepercent*/  generatedsavingslosses /* earnedsavingsowelosses */ reportedquality qualityscore aco1 aco2 aco3 aco4 aco5 aco6 aco7 aco8 aco9 aco10 aco11 aco12 aco13 aco14 aco15 aco16 aco17 aco18 aco19 aco20 aco21 dmcomposite /*aco22  aco23  aco24 aco25 aco26 */ aco27 aco28 /*aco29 */ aco30 aco31 /*cadcomposite  aco32 */ aco33 aco34 aco35 aco36 aco37 aco38 aco39 aco40 aco41 aco42 {
	*Don't do the replacement for Pioneer switchers (want their data to still be _PY2)
	...
	replace `varstub'_PY4=. if (start_date=="01/01/2015" & !inlist(aconame_cms,"HCP ACO CA LLC","Seton Accountable Care Organization, Inc.","Premier Choice ACO, Inc.","Physician Health Partners, LLC", "Franciscan Alliance ACO", "Genesys PHO, L.L.C."))
	*moving Y4 varaibles into Y1 for Y4 starters
}

foreach varstub in bene_states {
	replace `varstub'_PY2=`varstub'_PY4 if (start_date=="01/01/2015" & !inlist(aconame_cms,"HCP ACO CA LLC","Seton Accountable Care Organization, Inc.","Premier Choice ACO, Inc.","Physician Health Partners, LLC", "Franciscan Alliance ACO", "Genesys PHO, L.L.C."))
	replace `varstub'_PY4="." if (start_date=="01/01/2015" & !inlist(aconame_cms,"HCP ACO CA LLC","Seton Accountable Care Organization, Inc.","Premier Choice ACO, Inc.","Physician Health Partners, LLC", "Franciscan Alliance ACO", "Genesys PHO, L.L.C."))
	*moving Y4 varaibles into Y1 for Y4 starters
}
...
foreach varstub in track advancepaymentmodel totalassignedbeneficiaries totalbenchmarkexpenditures totalexpenditures /*expendituredollar expenditurepercent */ generatedsavingslosses /*earnedsavingsowelosses*/ reportedquality qualityscore aco1 aco2 aco3 aco4 aco5 aco6 aco7 aco8 aco9 aco10 aco11 aco12 aco13 aco14 aco15 aco16 aco17 aco18 aco19 aco20 aco21 dmcomposite /*aco22 aco23  aco24 aco25 aco26*/aco27 aco28 /*aco29 */ aco30 aco31 /*cadcomposite  aco32 */ aco33 aco34 aco35 aco36 aco37 aco38 aco39 aco40 aco41 aco42 {
	*Don't do the replacement for Pioneer switchers (want their data to still be _PY2)
	replace `varstub'_PY3=`varstub'_PY4 if (start_date=="01/01/2014" & !inlist(aconame_cms,"HCP ACO CA LLC","Seton Accountable Care Organization, Inc.","Premier Choice ACO, Inc.","Physician Health Partners, LLC", "Franciscan Alliance ACO", "Genesys PHO, L.L.C."))
	replace `varstub'_PY4=. if (start_date=="01/01/2014" & !inlist(aconame_cms,"HCP ACO CA LLC","Seton Accountable Care Organization, Inc.","Premier Choice ACO, Inc.","Physician Health Partners, LLC", "Franciscan Alliance ACO", "Genesys PHO, L.L.C."))
	*moving Y4 varaibles into Y1 for Y4 starters
...
foreach year in _PY1 _PY2 _PY3 _PY4 _PY5 {
	...
	*Matching ACO Names to CMS format 
		...
		*http://www.hcpnv.com/read_news/view.asp?ID=9&CID=6
		...
		replace aconame_cms="Premier Choice ACO, Inc." if aconame_cms== "Primecare Medical Network"		
...
gen `var'_PY5 = `var' if start_date == 18993 & !inlist(ACOName, "Bellin", "Beacon Health", "Steward")
gen `var'_PY4 = `var' if start_date == 19175 | start_date==19359 |  inlist(ACOName, "Bellin", "Beacon Health", "Steward")
...
drop `var'
	...
	*replace aconame_cms ="Allina Hospitals and Clinics" if aconame_cms==	//don't see on Nextgen 2016
	...
	replace aconame_cms ="Trinity Health Michigan d/b/a St. Mary Mercy Hospital" if aconame_cms=="Trinity Health" 
...
foreach year in PY1 PY2 PY3 PY4 PY5	{
replace finalsharerate_`year' = finalsharerate_`year'/100 if finalsharerate_`year'>1 & finalsharerate_`year'<.
}	
	
	
	save "/Volumes/NSACO/NSACO Data Master/CMS/merge2016PUFtoNSACO_working/ACO Innovators/aco_innovators_puf_data_050818.dta", replace
